...
function reverie_scripts_and_styles() {
  if (!is_admin()) {
    ...
    wp_register_script( 'reverie-modernizr', get_template_directory_uri() . '/js/vendor/custom.modernizr-ck.js', array(), '2.6.2', false );
    ...
    wp_register_script( 'reverie-js', get_template_directory_uri() . '/js/foundation-ck.js', array( 'jquery' ), '1', true );
